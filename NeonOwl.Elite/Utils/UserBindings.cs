...
namespace NeonOwl.Elite.Utils
{
    ...
    {
        [XmlAttribute] public string PresetName { get; set; }
        [XmlAttribute] public long MajorVersion { get; set; }
        [XmlAttribute] public long MinorVersion { get; set; }
    ...
    {
        [XmlAttribute] public string Device { get; set; }
    ...
    public class PrimaryInfo
    {
        [XmlAttribute] public string Device { get; set; }
        [XmlAttribute] public string Key { get; set; }
        [XmlElement("Modifier")] public List<Binding> Modifier { get; set; }
    }
